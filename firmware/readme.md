Firmware for the keyboard. [A pre-compiled firmware hex](nilsolav_default.hex)(nilsolav_dafult.hex) is provided for the default keymap ([shown here](nilsolav/keymaps/default/keymap.c)).
