Firmware for the keyboard. [A pre-compiled firmware hex](nilsolav_default.hex) is provided for the default keymap ([shown here](nilsolav/keymaps/default/keymap.c)).
