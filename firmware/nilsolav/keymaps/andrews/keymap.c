 ...
 */
  [NAV] = LAYOUT(
    ...
    KC_P1,          KC_UP,    _______,   _______,     KC_LSFT,  KC_Z,   KC_X,   KC_C,   KC_V,   KC_B,   KC_N,   KC_M,   KC_COMM,KC_DOT, KC_SLSH,KC_ENT , \
 ...
 */
  [LWR] = LAYOUT(
    KC_NLCK,  KC_PSLS,  KC_PAST,   KC_PMNS,     LSFT(KC_NUHS),  KC_EXLM, KC_DQUO, KC_NUHS, KC_DLR,  KC_PERC, KC_CIRC, KC_AMPR, KC_ASTR, KC_LPRN, KC_RPRN, _______, \
   ...
   * |  4  |  5  |  6  |     |  |     |     |     |     |     |     |     |     |     |  [  |  ]  |  @  |
   * |-----|-----|-----|-----|  |-----|-----|-----|-----|-----|-----|-----|-----|-----|-----|-----|-----|
   * |  1  |  2  |  3  | ENT |  |CAPS |     |     |     |     |  _  |  +  |     | pgdn| pgup|  \  |enter|
   * |-----|-----|-----|-----|  |-----|-----|-----|-----|-----|-----|-----|-----|-----|-----|-----|-----|
   * |  0  | 00  |  .  |     |  |     |     |     |     |     |           |     |next |vold |volu |play |
   * `-----------------------'  '-----------------------------------------------------------------------'
 */
  [RSE] = LAYOUT(
    ...
    KC_P1,    KC_P2,    KC_P3,     KC_PENT,     KC_CAPS, _______, _______, _______, _______, KC_UNDS, KC_PLUS, _______, KC_PGDN, KC_PGUP,    KC_NUBS,   _______, \
    KC_P0,    KC_DBL0,  KC_PDOT,                _______, _______, _______, _______, _______,     _______,      _______, KC_MNXT, KC_VOLD,    KC_VOLU,   KC_MPLY \
  ),
